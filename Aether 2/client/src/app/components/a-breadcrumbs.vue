<template>
  <div class="breadcrumbs">
    <router-link class="breadcrumb root" to="/">
      <img class="root-img" src="src/app/ext_dep/images/logo-small-optimised.png" alt="" :class="{'at-home': isAtHome}">
      <div class="breadcrumb-text" v-show="isAtHome">Home </div>
    </router-link>
    <router-link class="breadcrumb" v-for="bc in breadcrumbs" :to="'/'+bc.Link">
      <img class="soft-chevron" src="src/app/ext_dep/svg/softer-chevron.svg" alt="">

  ...
  <div class="view-header">
    ...
    <div class="center-container">
      <div class="header-container side-layout">
        <template v-if="$store.state.route.name === 'Global>NewBoard'">
          ...
          <div class="header-subtext">Hey there future admin! Consider taking a look at
            <router-link class="quickstart-link" to="/adminsquickstart">Admin's Quickstart</router-link> before diving in.
          </div>
        </template>
    ...
    <div class="side-container right">
      <div class="actions-container">
        <router-link to="/globalscope/newboard" class="button is-warning is-outlined" title="Create a new community" hasTooltip v-if="!localUserReadOnly" :disabled="newBoardButtonDisabled">
          NEW COMMUNITY
        </router-link>
      </div>
    </div>

...
if getattr(sys, 'frozen', False): # If this is a frozen PyInstaller bundle.
    ...
    if PLATFORM == 'OSX':
        ...
        BASE_URL = BASEDIR
        PROFILE_DIR = os.path.expanduser('~/Library/Application Support/AetherHeadless/')
    elif PLATFORM == 'WIN':
        BASEDIR = sys._MEIPASS+'/'
        BASE_URL = BASEDIR
        PROFILE_DIR = os.environ['ALLUSERSPROFILE']+'\\AetherHeadless\\'
    elif PLATFORM == 'LNX':
        BASEDIR = sys._MEIPASS+'/'
        BASE_URL = BASEDIR
        PROFILE_DIR = os.path.expanduser('~/aether_headless_profile/')
...
class UserProfile(object):
    ...
    def __produceProfileWithDefaults(self):
            ...
            machineDetails = {
                ...
                'lastConnectedBareIP': '151.236.11.192',
